...
`python main.py --mode=test --demo_model=1682000197`
`python main.py --mode=test --demo_model=1682001893`
...
`python main.py --mode=demo --demo_model=1682001893`
`python main.py --mode=demo --demo_model=1682320598`
