...
def home(request):
    return render(request, "niji/index/index.html")

def test(request):
    return render(request, 'niji/index/testmenu.html')

def tang(request):
    return render(request, "niji/test/唐朝.html")

def song(request):
    return render(request, 'niji/test/宋朝.html')

def success(request):
    return render(request, 'niji/index/suc.html')